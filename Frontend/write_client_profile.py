...
const profileSchema = z.object({
  ...
  phone: z.string().trim().max(30, 'Le numéro de téléphone est trop long.').optional().default(''),
...
'''
target = Path(r'c:/Users/liern/OneDrive/Bureau/AutoRental/Frontend/src/pages/client/ClientProfilePage.tsx')
