...
class Command(BaseCommand):
    ...
    vehicle_definitions = (
        ...
        {
            "code": "CLIO-NOIR",
            "registration_number": "GAC-CLIO-002",
            "model_name": "Clio",
            "recommended_use": "Ville, economique et facile a conduire",
            "category_name": "Citadine",
            "energy_type": "Essence",
        ...
        {
            "code": "CLIO-BLEU",
            "registration_number": "GAC-CLIO-003",
            "model_name": "Clio",
            "recommended_use": "Ville, economique et facile a conduire",
            "category_name": "Citadine",
            "energy_type": "Essence",
        ...
        {
            "code": "AUSTRAL-NOIR",
            "registration_number": "GAC-AUS-002",
            "model_name": "Austral",
            "recommended_use": "Famille, confortable et polyvalente",
            "category_name": "Familiale",
            "energy_type": "Hybride essence",
        ...
        {
            "code": "AUSTRAL-BLEU",
            "registration_number": "GAC-AUS-003",
            "model_name": "Austral",
            "recommended_use": "Famille, confortable et polyvalente",
            "category_name": "Familiale",
            "energy_type": "Hybride essence",
        ...
        {
            "code": "RAFALE-NOIR",
            "registration_number": "GAC-RAF-002",
            "model_name": "Rafale",
            "recommended_use": "Confort superieur et longs trajets",
            "category_name": "Superieure",
            "energy_type": "Hybride essence",
        ...
        {
            "code": "RAFALE-BLEU",
            "registration_number": "GAC-RAF-003",
            "model_name": "Rafale",
            "recommended_use": "Confort superieur et longs trajets",
            "category_name": "Superieure",
            "energy_type": "Hybride essence",
        ...
        with transaction.atomic():
            ...
            for definition in self.vehicle_definitions:
                ...
                vehicle_defaults = {
                    ...
                    "color": definition.get("color", self.common_vehicle_fields["color"]),
